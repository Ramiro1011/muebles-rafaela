<script>
  import {
    ...
    configLanding, configNosotros, configContacto, toast,
  } from '$lib/stores.js';
  ...
  async function publicarCambios() {
    ...
    try {
      ...
      setTimeout(() => { publicando = false; }, 60000);
    } catch (err) {
  ...
  <div class="admin-wrap">
    <header class="admin-header">
      ...
      <div class="admin-header-actions">
        ...
        <button class="btn btn-primary btn-sm" onclick={publicarCambios} disabled={publicando}>
